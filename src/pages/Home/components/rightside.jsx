...
export const RightSide = () => {
    return (
        <>
            <div className='friendsRequest max-[430px]:hidden z-3 fixed px-3 right-0 top-[15vh] flex flex-wrap gap-5 justify-center w-[24vw] h-[80vh] overflow-y-scroll   [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]'>
                <div className='bg-white shadow w-[85%] h-[85%] pt-[5%] px-[5%]'>
                        ...
                        <div className='flex w-[100%] h-[10vh] items-center'>
                            <div className='flex  w-[100%] h-[10vh] gap-3 items-center px-2'>
                                ...
                                <div className='flex h-[100%] flex-col justify-center'>
                                    ...
                                    <p className='p-0 m-0'>Localisation</p>
                                </div>
                            </div>
                ...
                <div className='bg-white shadow w-[85%] h-[54%] pt-[5%] px-[5%]'>
                    <h4>Friends Requeste</h4>
                    <div className='w-[100%] h-[80%] overflow-hidden'>
                        <div className='flex w-[100%] h-[10vh] items-center'>
                            <div className='flex  w-[100%] h-[10vh] gap-3 items-center px-2'>
