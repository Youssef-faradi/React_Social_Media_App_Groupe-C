...
export const SidebarSectionHome = () => {
    ...
    return (
        ...
        <>
            <div className=' max-[430px]:justify-center  max-[430px]:bg-[--white]   max-[430px]:h-[10vh] max-[430px]:p-0  max-[430px]:w-[100vw] position-fixed ps-[3%] z-3 fixed  min-[430px]:top-[10vh]  items-center bottom-0 bg-[--gray]  left-0  flex flex-wrap gap-5 justify-center w-[22.5vw] h-[90vh] '>
