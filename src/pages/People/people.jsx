...
export const People = () => {
  ...
  return (
    <>
      <div className="flex flex-wrap  gap-3  p-3 bg-gray-200 pt-12">
        {/* Card start */}
        {
            MyPoeple.map((element, index) => 
            <>
            
            
            <div className="max-w-sm mx-auto bg-white w-auto dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg">
          <div className="border-b px-4 pb-6">
            <div className="text-center my-4">
              <img
                className="h-32 w-32 rounded-full border-4 border-white dark:border-gray-800 mx-auto my-4"
                src={element.profilPic}
                alt=""
              />
              <div className="py-2">
