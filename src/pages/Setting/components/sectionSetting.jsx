                  ...
                  <div className="row mt-5 align-items-center">
                    ...
                    <div className="col">
                      <div className="row align-items-center">
                        <div className="col-md-7">
                          ...
                          <p className="small mb-3">
                            <span className="badge badge-dark text-black">
                              New York, USA
                            </span>
                          </p>
                        </div>
                      ...
                      <div className="row mb-4">
                        <div className="col-md-7">
                        <textarea placeholder="Bio" className="textarea p-1 border-collapse bg-lime-100  textarea-lg w-full max-w-xs" ></textarea>
                        </div>
                        <div className="col">
